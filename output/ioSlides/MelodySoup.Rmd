...
```{r}
load("~/Google Drive/Columbia/5243 ADS/ADS Proj 5/Fall2016-proj5-grp2/output/ioSlides/plots/EDA_plot.RData")
p1
```
...
```{r}
load("~/Google Drive/Columbia/5243 ADS/ADS Proj 5/Fall2016-proj5-grp2/output/ioSlides/plots/NB.RData")
t2
```
...
```{r}
load("~/Google Drive/Columbia/5243 ADS/ADS Proj 5/Fall2016-proj5-grp2/output/ioSlides/plots/BeatIt.RData")
BeatItChord
```
...
```{r}
load("~/Google Drive/Columbia/5243 ADS/ADS Proj 5/Fall2016-proj5-grp2/output/ioSlides/plots/Sankey.Rdata")
Sankey
```

## 4-Gram using tf-idf: R&B genre
```{r}
load("~/Google Drive/Columbia/5243 ADS/ADS Proj 5/Fall2016-proj5-grp2/output/ioSlides/plots/R&B_Sankey.RData")
RB_Sankey
```

## 4-Gram using tf-idf: Country genre 
```{r}
load("~/Google Drive/Columbia/5243 ADS/ADS Proj 5/Fall2016-proj5-grp2/output/ioSlides/plots/Country_Sankey.RData")
p
```
