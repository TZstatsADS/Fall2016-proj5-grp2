...
chorddiag(chordmatrix,groupnameFontsize=12,groupnamePadding = 20,groupColors=chordcolors)
...
chorddiag(Genre.Top2G.Matrix,groupnameFontsize=8,groupnamePadding = 20,showTicks = FALSE,chordedgeColor =NULL,palette = "Set3",groupColors =Genre.Top2G.Color )
